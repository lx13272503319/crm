		...
		$.ajax({
			...
			//	[{市场1},{2},{3}]
				...
				$.each(data,function (i,obj){
					...
					html+= '<td>'+obj.endDate+'</td>'
					html+= '<td>'+obj.owner+'</td>'
					html+= '<td><a href="javascript:void(0);" onclick="unbond(\''+obj.id+'\')"  style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>'
					html+= '</tr>'
				})
...
<%--							</tr>--%>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="bundBtn">绑定</button>
				</div>
			</div>
		</div>
	</div>
...
<%--						</tr>--%>
			...
			<div>
				<a href="javascript:void(0);"  onclick="modalFocus()" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
