...
<script>
	$(function (){
		...
		//为阶段的下拉框绑定事件，填写对应的可能性
		$("#create-stage").change(function (){
			var stage=$("#create-stage").val();
			//当json的key为一个变量时，只能用中括号的方式取值
...
<%--				  <option>聊天</option>--%>
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="市场活动1">
				<input type="hidden" name="activityId" value="11b818747a45486d85a146bd7ce445bf">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="ba57c55baa2045c68e9fd150b0de48a3">
			</div>
		</div>
